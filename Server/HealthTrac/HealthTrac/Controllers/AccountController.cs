...
namespace HealthTrac.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    return RedirectToRoute("Index", user);
                }
                else
                {
        ...
        // Method is a fix for known issue with OAUTH from 
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            else
            {
                ...
                return View("ExternalLoginFailure", new ExternalLoginFailureViewModel { Message = "Please make an account in the mobile app to login" });
            }
        }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // replaces original method call with workaround
                var info = await AuthenticationManager_GetExternalLoginInfoAsync_Workaround(); //AuthenticationManager.GetExternalLoginInfoAsync();
                if (info == null)
                {
